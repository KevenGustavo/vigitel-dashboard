<template>
  <div class="bg-card border border-border rounded-xl shadow-sm p-3.5 sm:p-4 xl:p-5 flex flex-col justify-between h-full relative">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 sm:gap-2 pb-2.5 sm:pb-3 border-b border-border/60">
      <div class="flex items-center gap-2 min-w-0">
        ...
        <div class="relative group/info shrink-0 cursor-help">
          <button
            ...
            aria-label="Informações sobre Doenças Crônicas e Nutrição"
          >
      ...
      <div class="flex items-center gap-1.5 text-[10.5px] sm:text-xs text-rose-600 font-medium bg-rose-50 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md shrink-0 border border-rose-200/60 self-start sm:self-auto">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative group/metodo inline-flex items-center cursor-help">
          <button
            ...
            class="text-rose-800 font-semibold bg-rose-50 hover:bg-rose-100/90 active:scale-95 px-2 py-0.5 rounded-md border border-rose-200/70 transition-colors flex items-center gap-1 cursor-pointer"
          >
