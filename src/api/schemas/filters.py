...
class FiltrosDisponiveis(BaseModel):
    ...
    """
    anos: List[int]
    cidades: List[dict]  # Ex: [{"id_cidade": "sao paulo", "nome_cidade": "São Paulo"}]
...
class QueryFilters:
    ...
    def __init__(
        ...
        cidade: Optional[List[str]] = Query(None, description="Filtrar pelo ID da cidade (ex: sao paulo, rio de janeiro)"),
