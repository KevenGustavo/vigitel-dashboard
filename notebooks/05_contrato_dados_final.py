"""
Contrato de Dados - VIGITEL (Bronze -> Silver)
Este dicionário atua como o 'De-Para' oficial do ETL.
Ele padroniza os nomes obscuros do inquérito (ex: q59) para nomes autodescritivos,
facilitando a interpretação na modelagem dimensional (camada Gold) e no front-end.
"""

SCHEMA_BRONZE_TO_SILVER = {
    # ----------------------------------------------------
    ...
    'ano': 'ano_coleta',
    'cidade': 'id_cidade',
    'pesorake2025': 'peso_amostral',  # Peso atualizado pelo Censo 2022 (Série 2006-2024)
    ...
    'q51': 'duracao_trajeto_trabalho',     # CRÍTICA: necessária para calcular minutos de deslocamento
    'q52': 'frequenta_escola',
    'q53': 'deslocamento_escola_ativo',
    'q54': 'duracao_trajeto_escola',        # CRÍTICA: necessária para calcular minutos de deslocamento
    ...
    'r201': 'horas_sentado_dia',           # CRÍTICA: indicador direto de sedentarismo
...
def get_colunas_brutas():
    """Retorna apenas as chaves originais do VIGITEL para usar no read_csv do Pandas."""
    return list(SCHEMA_BRONZE_TO_SILVER.keys())

def get_renomeacao_silver():
    """Retorna o dicionário de mapeamento para o df.rename(columns=...)"""
    return SCHEMA_BRONZE_TO_SILVER

if __name__ == '__main__':
    print("Contrato de Dados VIGITEL gerado com sucesso!")
    print(f"Total de colunas monitoradas: {len(SCHEMA_BRONZE_TO_SILVER)}")
